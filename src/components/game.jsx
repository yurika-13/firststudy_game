...
function GamePlay(){
    ...
    return(
        <div className="gameplay">
            ...
            {/*start window*/}
            <h1>Are you ready ...?</h1>
            <Button variant="primary" size="lg" /*disabled(無効化ボタン！)*/ onClick={startTimer}>
             start!
            </Button>
            </div>
            ):(
               <>
               <Button variant="primary" size="lg" /*disabled(無効化ボタン！)*/ onClick={stopTimer}>
                stop!
               </Button>
               <Button variant="primary" size="lg" /*disabled(無効化ボタン！)*/ onClick={restartTimer}>
                restart!
               </Button>
               </>   
            )
